<x-guest-layout>
    <div class="text-center mb-6">
        ...
        <p class="text-gray-600 mt-2">Bergabunglah dengan kami untuk layanan terbaik</p>
    </div>

    <!-- Google Register Button -->
    <div class="mb-6">
        <a href="{{ route('auth.google') }}" class="w-full inline-flex items-center justify-center px-4 py-3 bg-white border border-gray-300 rounded-lg font-semibold text-sm text-gray-700 hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm">
